...
const BookOfTheWeek = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden flex flex-col md:flex-row items-center p-6 gap-6 my-6 transform transition duration-300 hover:scale-[1.02]">
      <img
      ...
      <div className="flex-1">
        ...
        <p className="text-gray-500 mb-4">Rating: {featuredBook.rating}</p>
