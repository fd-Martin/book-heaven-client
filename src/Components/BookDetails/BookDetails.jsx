...
const BookDetails = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://book-heaver-server.vercel.app/api/book-details/${id}`)
      .then((res) => {
        setBook(res.data);
  ...
  useEffect(() => {
    ...
    const fetchComments = () => {
      axios
        .get(`https://book-heaver-server.vercel.app/api/comments/${id}`)
  ...
  const handleCommentSubmit = async () => {
    ...
    try {
      await axios.post(
        "https://book-heaver-server.vercel.app/api/add-comment",
        commentData
      );
      setNewComment("");
